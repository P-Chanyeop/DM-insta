...
public class TemplateSeedData implements CommandLineRunner {
    ...
    private static final java.util.Map<String, String> CATEGORY_IMAGES = java.util.Map.of(
            "SHOPPING", "/images/templates/shopping.png",
            "BOOKING", "/images/templates/booking.png",
            "EVENT", "/images/templates/event.png",
            "LEAD", "/images/templates/lead.png",
            "SUPPORT", "/images/templates/support.png"
    );
    ...
    public void run(String... args) {
        ...
        templateRepository.findAll().forEach(t -> {
            if (t.getPreviewImageUrl() == null || t.getPreviewImageUrl().isBlank()) {
                ...
                if ("SHOPPING".equals(t.getCategory()) && t.getName() != null && t.getName().contains("공동구매")) {
                    img = "/images/templates/groupbuy.png";
                }
                if (img != null) {
        ...
        templateRepository.save(Template.builder()
                ...
                .previewImageUrl("/images/templates/shopping.png")
        ...
        templateRepository.save(Template.builder()
                ...
                .previewImageUrl("/images/templates/event.png")
        ...
        templateRepository.save(Template.builder()
                ...
                .previewImageUrl("/images/templates/lead.png")
        ...
        templateRepository.save(Template.builder()
                ...
                .previewImageUrl("/images/templates/support.png")
        ...
        templateRepository.save(Template.builder()
                ...
                .previewImageUrl("/images/templates/groupbuy.png")
