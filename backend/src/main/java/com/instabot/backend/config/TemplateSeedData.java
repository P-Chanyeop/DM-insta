...
public class TemplateSeedData implements CommandLineRunner {
    ...
    public void run(String... args) {
        ...
        templateRepository.save(Template.builder()
                ...
                .previewImageUrl("/images/templates/shopping.svg")
        ...
        templateRepository.save(Template.builder()
                ...
                .previewImageUrl("/images/templates/booking.svg")
        ...
        templateRepository.save(Template.builder()
                ...
                .previewImageUrl("/images/templates/event.svg")
        ...
        templateRepository.save(Template.builder()
                ...
                .previewImageUrl("/images/templates/lead.svg")
        ...
        templateRepository.save(Template.builder()
                ...
                .previewImageUrl("/images/templates/support.svg")
        ...
        templateRepository.save(Template.builder()
                ...
                .previewImageUrl("/images/templates/groupbuy.svg")
